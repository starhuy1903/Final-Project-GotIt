...
const DeleteConfirm :React.FC<DeleteConfirmProps> = ({item, title, onSubmit, closeHandler}) => {

    return <PopupWrapper title={title} closeHandler={closeHandler}>
        <div className="u-flex u-flexColumn u-alignItemsCenter u-widthFull">
        <p>Are you sure to delete <span className="u-fontBold">{item.name}</span> ?</p>
