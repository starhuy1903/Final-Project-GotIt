...
const ItemDetail = () => {
  ...
  return <div className="u-marginVerticalSmall u-widthFull u-flex u-justifyContentCenter" style={{margin: "30px auto"}}> 
  {loading ? (<Loader duration={500} size="large" />) : (
    <div className="u-flex">
    <div>
      <img src={data?.imageUrl} alt="image" className="" style={{width: "300px"}} />
    </div>
